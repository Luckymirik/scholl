...
class SchoolApplicationTests {
	...
	public void testGetStudentInfo() throws Exception {
		Assertions.assertEquals(this.restTemplate.getForObject("http://localhost:" + port + "/student/1", String.class),
				"{\"id\":1,\"name\":\"Гарри Поттер\",\"age\":10,\"faculty\":{\"id\":1,\"name\":\"Гриффиндор\",\"color\":\"Красный\",\"studentList\":[]}}");
	}
	@Test
	public void testGetStudentInfoAge() throws Exception {
		Assertions.assertEquals(this.restTemplate.getForObject("http://localhost:" + port + "/student?age=3", String.class),
	...
	public void testGetFacultyInfoColorOrName() throws Exception {
		Assertions.assertEquals(this.restTemplate.getForObject("http://localhost:" + port + "/faculty/get-color-or-name?str=красный", String.class),
				"[{\"id\":1,\"name\":\"Гриффиндор\",\"color\":\"Красный\",\"studentList\":[]}]");
	}
	@Test
